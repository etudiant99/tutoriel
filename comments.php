...
<p>Connecté comme <a href="<?php echo get_option('siteurl'); ?>/wp-admin/profile.php"><?php echo $user_identity; ?></a>. <a href="<?php echo get_option('siteurl'); ?>/wp-login.php?action=logout" title="Déconnection de ce compte">Déconnection &raquo;</a></p>
...
<label for="email"><small>courriel (ne sera pas publi&eacute;) <?php if ($req) echo "(requis)"; ?></small></label></p>
